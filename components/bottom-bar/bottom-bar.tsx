...
export default function BottomBar() {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-4 px-2 py-1.5 bg-stone-200/90 dark:bg-neutral-800/90 backdrop-blur-sm rounded-full shadow-lg border border-stone-300 dark:border-neutral-700">
        {session ? (
          <>
